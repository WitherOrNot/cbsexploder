...
/*
Based on https://github.com/seven-mile/CallCbsCore
*/
...
#pragma region CBSCore Exported Functions

typedef HRESULT(WINAPI* PCBS_CORE_INITIALIZE)(IMalloc*, int(WINAPI*)(int), void (*)(), void (*)(), void (*)(), void (*)(), void (*)(), IClassFactory**);
typedef HRESULT(WINAPI* PCBS_CORE_SET_STATE)(int state, PROC value);
typedef HRESULT(WINAPI* PCBS_CORE_FINALIZE)();

extern PCBS_CORE_INITIALIZE CbsCoreInitialize;
extern PCBS_CORE_SET_STATE CbsCoreSetState;
extern PCBS_CORE_FINALIZE CbsCoreFinalize;

#pragma endregion

#pragma region WDSCore Exported Functions

typedef HRESULT(WINAPI* PWDS_SETUP_LOG_MESSAGEW)(LPVOID pMsg, enum WdsLogSource source, LPCWSTR str1, LPCWSTR str2, ULONG, LPCWSTR file, LPCWSTR func, void* CurIP, ULONG, void*, UINT);
typedef LPVOID(WINAPI* PCONSTRUCT_PARTIAL_MSG_VW)(WdsLogLevel level, LPCSTR fmtMsg, va_list va);
typedef LPVOID(*PCURRENT_IP)();

extern PWDS_SETUP_LOG_MESSAGEW WdsSetupLogMessageW;
extern PCONSTRUCT_PARTIAL_MSG_VW ConstructPartialMsgVW;
extern PCURRENT_IP CurrentIP;

#pragma endregion

#pragma region CBS Interfaces
...
MIDL_INTERFACE("75207392-23F2-4396-85F0-8FDB879ED0ED") ICbsUIHandler : IUnknown{
  virtual HRESULT STDMETHODCALLTYPE QueryInterface(REFIID riid, _Out_ LPVOID* ppvObject) override = 0;
  virtual ULONG STDMETHODCALLTYPE AddRef(void) override = 0;
  virtual ULONG STDMETHODCALLTYPE Release(void) override = 0;
...
MIDL_INTERFACE("75207391-23F2-4396-85F0-8FDB879ED0ED") ICbsSession : IUnknown{
  virtual HRESULT STDMETHODCALLTYPE QueryInterface(_In_ REFIID riid, _Out_ LPVOID* ppvObject) override = 0;
  virtual ULONG STDMETHODCALLTYPE AddRef(void) override = 0;
  virtual ULONG STDMETHODCALLTYPE Release(void) override = 0;
